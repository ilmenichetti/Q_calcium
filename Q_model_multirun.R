...
Q_decomposition_multi<-function(inputs, #input vector
                          beta,
                          eta_11,
                          e0,
                          fc,
...
Q_Ca_multi<-function(#variables:
  ...
  ###### CARBON WITH Q
  Litter_run=Q_decomposition_multi(inputs=I_F_C, spinup = spinup, 
                                   beta=beta,
                                   eta_11=eta_11,
                                   e0=e0,
                                   fc=fc,
                                   ...
                                   tmax=tmax,
                                   delay=delay)
  CWD_run=Q_decomposition_multi(inputs=I_D_C, spinup = spinup,
                                beta=beta,
                                eta_11=eta_11,
                                e0=e0,
                                fc=fc,
